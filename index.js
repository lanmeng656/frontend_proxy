...
//创建服务
var httpServer = http.createServer(processreq);
...
function processreq (req, res) {
    ...
    if(reqUrl.indexOf(config.apiPath)==0&&req.method==config.method){
        return req.pipe(request('http://'+config.remoteHost+reqUrl)).pipe(res);
    }
